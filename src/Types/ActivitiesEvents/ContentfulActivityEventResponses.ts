...
export interface ContentfulPreviousActivityEventCardResponse
  extends ContentfulActivityEventBannerResponse,
    ContentfulBaseActivityEventCardResponse,
    ContentfulPreviousActivityEvent {}

export interface ContentfulUpcomingActivityEventCardResponse
  extends ContentfulActivityEventBannerResponse,
    ContentfulBaseActivityEventCardResponse,
    ContentfulUpcomingActivityEvent {}

export interface ContentfulActivityEventResponse
  extends ContentfulBaseActivityEventCardResponse,
    ContentfulUpcomingActivityEvent,
    ContentfulPreviousActivityEvent {
  speaker: string;
  topics: string[] | null;
